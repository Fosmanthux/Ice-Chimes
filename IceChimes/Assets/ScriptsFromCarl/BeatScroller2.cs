...
public class BeatScroller2 : MonoBehaviour
{
   ...
   // public GameObject[] arrowsToChooseFrom = new GameObject[4];
    ...
    public int[] beatMap1notes = {1, 2, 3, 2, 1, 2, 2, 3, 3, 1, 2, 3, 1, 1, 2, 3, 2, 1, 2};
    ...
    public void spawnArrow(int note, int position)
    {
        ...
        switch (note)
         {
             case 1:
                 allNotes.Add(GameObject.Instantiate(Left_Arrow, new Vector3(-1f, 0, 25), Quaternion.Euler(0f, 180f, 0f)));
                 allNotes[position].SetActive(true);
                break;
             case 2:
                allNotes.Add(GameObject.Instantiate(Up_Arrow, new Vector3(0f, 0, 25), Quaternion.Euler(0f, 0f, 90f)));
                allNotes[position].SetActive(true);
                break;
             case 3:
                allNotes.Add(GameObject.Instantiate(Down_Arrow, new Vector3(1f, 0, 25), Quaternion.Euler(0f, 0f, -90f)));
                allNotes[position].SetActive(true);
                break;
             case 4:
